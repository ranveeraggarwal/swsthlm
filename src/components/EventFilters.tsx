        ...
        {totalCount === 0 ? (
          <div className="text-center py-16 border border-dashed border-[var(--surface-container-highest)] rounded bg-[var(--surface-container-low)] p-8">
            ...
            <button
              ...
              className="inline-flex items-center justify-center gap-2 px-6 py-3 rounded border-2 border-[var(--on-surface)] bg-[var(--surface-container)] font-bold text-sm hover:bg-[var(--surface-container-high)] hover:-translate-y-0.5 hover:shadow-[2px_2px_0px_0px_var(--on-surface)] transition-all cursor-pointer"
            >
              Clear all filters
            </button>
          </div>
