    ...
    >
      ...
      >
        <button
          ...
          className="absolute right-3 top-3 rounded-full p-1.5 text-[var(--outline)] hover:bg-[var(--surface-container)] transition-colors focus-visible:ring-2 focus-visible:ring-[var(--primary)] focus:outline-none"
        >
