  ...
  return (
    <>
      <button
        ...
        className="inline-flex items-center justify-center w-10 py-2 rounded border border-[var(--on-surface)] bg-[var(--surface-container)] text-[var(--on-surface-variant)] hover:bg-[var(--surface-container-high)] transition-colors cursor-pointer shrink-0"
      >
                ...
                if (typeof action === 'function') {
                  return (
                    <button
                      ...
                      type="button"
                      onClick={action}
                      className={`flex items-center justify-center gap-2.5 rounded border-2 border-[var(--on-surface)] px-4 py-3 font-sans text-sm font-bold transition-all hover:-translate-x-0.5 hover:-translate-y-0.5 hover:shadow-[2px_2px_0px_0px_var(--on-surface)] cursor-pointer ${className}`}
                    >
                      <Mark />
                      {label}
                    </button>
