          ...
          <div className="text-center py-16 border border-dashed border-[var(--surface-container-highest)] rounded bg-[var(--surface-container-low)] p-8">
            ...
            {hasActiveFilters && (
              <button
                ...
                className="inline-flex items-center gap-2 px-6 py-2.5 rounded border-2 border-[var(--on-surface)] bg-[var(--primary)] text-white hover:bg-[var(--primary-container)] font-bold uppercase tracking-wider text-xs transition-all hover:-translate-y-0.5 hover:-translate-x-0.5 hover:shadow-[2px_2px_0px_0px_var(--on-surface)] cursor-pointer"
              >
                Clear all filters
              </button>
            )}
